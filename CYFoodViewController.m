...
@interface CYFoodViewController ()<UITableViewDelegate, UITableViewDataSource>
...
@implementation CYFoodViewController
...
- (void)requestDataFromNetworking
{
    ...
    [manager GET:@"https://open.seriousapps.cn/4/tab/home_page.json?city_id=299&lat=22.58000345788662&lng=113.9617382240522&page=0&tab_id=1003" parameters:nil progress:^(NSProgress * _Nonnull downloadProgress) {
        //页面刷新进度TODO::::
